...
<script type="text/javascript">
	...
	function Loading() {
	    ...
	    loadingImg +="<img src='images/loading.gif' style='position: absolute; top:40%; left:40%;  display: block; margin: 0px auto;'>";
	    loadingImg +="</div>"; 
				...
				<div class="col-xl-3">
					<div class="right-side">
						...
						<div class="tag-list">
							...
							<a href="totalApi.do?&pc=PRA000 " onclick="Loading()" >가방</a> <a
								href="totalApi.do?&pc=PRH000" onclick="Loading()">지갑</a> <a
								href="totalApi.do?&pc=PRJ000" onclick="Loading()">휴대폰</a> <a
								href="totalApi.do?&pc=PRN000" onclick="Loading()">증명서</a> <a
								href="totalApi.do?&pc=PRK000" onclick="Loading()">옷</a> <a
								href="totalApi.do?&pc=PRO000" onclick="Loading()">귀금속</a> <a
								href="totalApi.do?&pc=PRQ000" onclick="Loading()">쇼핑백</a> <a
								href="totalApi.do?&pc=PRP000" onclick="Loading()">카드</a>
						</div>
					</div>
				</div>
