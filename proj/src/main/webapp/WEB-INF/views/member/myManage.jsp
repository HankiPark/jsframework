							...
							<div class="accordion-panel">
								...
								<div id="collapseSix" class="panel-collapse collapse show"
									...
									<c:if test="${member.picture eq null}">
										<img src="images/flower0.jpg" loading="lazy" class="img-fluid" width="250px"  alt="picture">
									</c:if>
					...
					<div class="card">
						...
						<div class="card-block accordion-block color-accordion-block">
							<div class="color-accordion" id="color-accordion">
								<a class="accordion-msg b-none waves-effect waves-light">구현중입니다.</a>
								<div class="accordion-desc">
									<p>나는 긴 글을 좋아한다. 긴 글의 여백도 좋고 빡빡하게 다져진 호흡도 좋다. 긴 글을 쓰기에 나는 이미 플랫폼에 너무나 적응을 잘 한 상태이겠지만, 오랜만에 돌아오거나 플랫폼의 적응과 관계 없이 (긴) 글 스타일을 고수하는 사람들을 글을 읽을 때면 즐거워진다. 어떤 가치를 고수하는 건 그만큼 (누군가에는) 어렵고 매일을 다잡지 않으면 안되는 일이기 때문이다.

</p>
								</div>
								<a
									class="accordion-msg bg-dark-primary b-none waves-effect waves-light">구현중입니다.</a>
								<div class="accordion-desc">
									<p>나는 긴 글을 좋아한다. 긴 글의 여백도 좋고 빡빡하게 다져진 호흡도 좋다. 긴 글을 쓰기에 나는 이미 플랫폼에 너무나 적응을 잘 한 상태이겠지만, 오랜만에 돌아오거나 플랫폼의 적응과 관계 없이 (긴) 글 스타일을 고수하는 사람들을 글을 읽을 때면 즐거워진다. 어떤 가치를 고수하는 건 그만큼 (누군가에는) 어렵고 매일을 다잡지 않으면 안되는 일이기 때문이다.
</p>
								</div>
								<a
									class="accordion-msg bg-darkest-primary b-none waves-effect waves-light">구현중입니다.</a>
								<div class="accordion-desc">
									<p>나는 긴 글을 좋아한다. 긴 글의 여백도 좋고 빡빡하게 다져진 호흡도 좋다. 긴 글을 쓰기에 나는 이미 플랫폼에 너무나 적응을 잘 한 상태이겠지만, 오랜만에 돌아오거나 플랫폼의 적응과 관계 없이 (긴) 글 스타일을 고수하는 사람들을 글을 읽을 때면 즐거워진다. 어떤 가치를 고수하는 건 그만큼 (누군가에는) 어렵고 매일을 다잡지 않으면 안되는 일이기 때문이다.
