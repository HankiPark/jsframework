...
import co.three.prj.command.NomalNoticeDelete;
import co.three.prj.command.NomalNoticeEdit;
...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		map.put("/readNotice.do", new ReadNotice());	//공지 상세 페이지
		map.put("/nomalNoticeDelete.do", new NomalNoticeDelete());	// 공지 상세 페이지 삭제
		map.put("/nomalNoticeEdit.do", new NomalNoticeEdit());	//공지 상세 수정
